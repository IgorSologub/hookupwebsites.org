...
public class BasePage {
    ...
    private final By mainLogoButton = By.xpath("//a[@class='silwVl1JBf']");
    private final By headerMenuOpen = By.xpath("//button[@class='VjguTh1qw js-modal-btn']");
    private final By languageMenuOpen = By.xpath("(//a[@class='FxauP2Xt Zf_h8G6oS js-header-drop-btn '])[4]");
    ...
    public BasePage headerButtonClick (int numButton) {
        By headerButton = By.xpath("(//a[@class='FxauP2Xt '])[" + numButton + "]");
        driver.findElement(headerButton).click();
        return this;
    }

    public BasePage headerMenuOpen () {
        By headerButton = By.xpath("(//a[@class='FxauP2Xt '])[2]");
    ...
    public BasePage footerButtonClick (int numButton) {
        By footerButton = By.xpath("(//a[@class='Pol6J6g'])[" + numButton + "]");
